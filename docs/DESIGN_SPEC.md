# Design Specification — Peizhong Gao Homepage
...
- **Project names**: Kimi-Researcher, Kimi K2, Kimi K2 Thinking, Meta
  ...
  Bamboo Agents.
- **Role hooks**: "core contributor", "owned the Data Science capability",
  "first author", "return offer", "Incoming · Summer 2026".
- **Metric numbers**: 574 citations, 8.6% → 26.9%, Rank 1 / 77.
