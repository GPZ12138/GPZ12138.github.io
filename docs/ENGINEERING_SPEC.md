# Engineering Specification — Peizhong Gao Homepage
...
└─────────┬──────────────┘       └─────────────────────────┘
          │
          │  fetch('data/scholar.json')   ◄── GitHub Actions cron (6h)
          ▼                                   writes this JSON
┌────────────────────────┐       ┌─────────────────────────┐
...
- Contract:
  ...
  ```jsonc
  {
    ...
    "scholar_id": "Jwg8XugAAAAJ",
    "total_citations": 0,          // int
    "h_index": 0,                  // int
    "i10_index": 0,                // int
    "publications_count": 0,       // int
    "per_year": { "2023": 0, ... },// Record<string, int>
...
- Reads the profile for `SCHOLAR_ID` (env var, defaults to
  `Jwg8XugAAAAJ`) via `scholarly`.
